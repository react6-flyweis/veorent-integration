...
export function ActionButton({ icon, label }: { icon: string; label: string }) {
  return (
    <Button className="group text-foreground hover:text-accent w-full justify-between rounded-lg bg-blue-100 py-6">
